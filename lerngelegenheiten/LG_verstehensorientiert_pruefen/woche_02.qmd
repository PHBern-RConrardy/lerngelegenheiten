...
git Programmieren sie eine Software, welche eine Frage stellt und nach 3 Fehlversuchen “Prüfung leider nicht bestanden” ausgibt (inkl. verbleibende Versuche). Wenn die Frage richtig beantwortet wird, soll “Gratulation!” ausgegeben werden.
...
while anzahl_versuche < 3:
    antwort = input("Hauptstadt?")
    if antwort == "Bern":
        print("toll")
        anzahl_versuche = 5
    else:
        print("leider falsch, du hast noch " + str(3 - anzahl_versuche) + " Versuche")
