...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-note-color!10!white, breakable, left=2mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Ziele des Lernmoduls}, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-caution-color!10!white, breakable, left=2mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Auftrag auf LearningView}, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, arc=.35mm, leftrule=.75mm]
