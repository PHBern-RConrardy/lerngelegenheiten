...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Ziele des Lernmoduls}, left=2mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, coltitle=black, toprule=.15mm, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Auftrag auf LearningView}, left=2mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-caution-color!10!white, colback=white, coltitle=black, toprule=.15mm, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, opacityback=0]
