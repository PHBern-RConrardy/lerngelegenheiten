...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, coltitle=black, opacityback=0, arc=.35mm, toprule=.15mm, colback=white, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Ziele des Lernmoduls}, colframe=quarto-callout-note-color-frame, rightrule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, coltitle=black, opacityback=0, arc=.35mm, toprule=.15mm, colback=white, breakable, colbacktitle=quarto-callout-caution-color!10!white, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Auftrag auf LearningView}, colframe=quarto-callout-caution-color-frame, rightrule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, left=2mm]
