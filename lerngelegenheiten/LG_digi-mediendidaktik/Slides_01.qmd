...
Lesen Sie in Ammann [-@ammann_mit_2009]. Ist die beschriebene Medienkompetenz eine Kompetenz gemäss dem Begriff von Weinert [-@weinert_leistungsmessungen_2014]?
...
Lesen Sie den Artikel auf [spiegel.de](https://www.spiegel.ltd/ausland/Die-Ampel-bringt-die-deutsche-Wirtschaft-um-a-59c26d99-301d-4205-91f7-20a467543d66.html) über die *deutsche Wirtschaft*. Schreiben Sie in einem Abschnitt welche Informationen Sie aus dem Artikel ziehen.
*(Hinweis: falls der Artikel nicht mehr verfügbar ist, finden Sie ihn auch auf meinem Zotero)*
:::
...
Schreiben Sie alle Dateien in einem Ordner in eine Liste.
...
Benennen Sie die Datei um als CSV. Mit welchem Programm werden bei Ihnen `.csv` Dateien geöffnet?
:::
...
[vgl. Wikipedia](https://de.wikipedia.org/wiki/Informatik#K%C3%BCnstliche_Intelligenz)
:::
...
# Medienerfahrung von Jugendlichen
...
Nimmt der Konsum digitaler Medien bei Jugendlichen in den letzten Jahren zu oder ab?
...
Weshalb könnte in der James Studie 2024 (S.37) der Mittelwert der Internetnutzungsdauer sich vom Median unterscheiden?
:::
...
Informieren Sie sich in einer kurzen Webrecherche über den jetzigen Stand der *Crypto Wars*. Soll der Staat die Möglichkeit erhalten in private Kommunikationskanäle mitzulesen um insb. Pädokriminalität zu bekämpfen?
:::
