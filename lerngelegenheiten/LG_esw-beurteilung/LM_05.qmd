...
Lernen Sie in [diesem Input](https://tube.switch.ch/embed/9kC6iEOr0a?title=hide) eine Grundhaltung sowie grundlegende Überlegungen zu förderorientiertem Unterricht kennen.


## Förderorientierung konkret - Das Churer-Modell

In [diesem Video](https://tube.switch.ch/embed/9f2bb6e8?title=hide) lernen Sie eine Möglichkeit einer didaktischen Umsetzung kennen, die einen förderorientierten Unterricht ermöglichen soll.
...
Lernen Sie in [diesem Input](https://tube.switch.ch/embed/b5vmCj1lsa?title=hide) Möglichkeiten und Instrumente zur förderorientierten Diagnostik kennen.

## Umsetzungsbeispiel

Mit dem [folgenden Screencast](https://tube.switch.ch/embed/go3UJXxybi?title=hide) stellen wir Ihnen ein Umsetzungsbeispiel vor, in welchem sowohl förderorientierter als auch kompetenzorientierter Unterricht, formative sowie summative Beurteilung zur Anwendung kommen.
