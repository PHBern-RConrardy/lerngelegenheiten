---
title: "<small>How to flip the right way: <br>Fail, flip, fix and feed in practice</small>"
...
![](2024_11_21_Zukunftsforum/aufbau.svg)

::: quelle

<span style="background-color: #ffc50b; color: black;  border: 2px solid #ffc50b; padding: 2px;">In class</span>
<span style="background-color: #094372; color: white;  border: 2px solid #094372; padding: 2px;">Out of class</span>
...
:::{.fragment .fade-up}
TOST-Äquivalenztest [vgl. @walker_understanding_2010] - Statistically **not** equivalent *and* not different.
:::
...
Null Hypothesis Test Result:
The null hypothesis test was significant, t(143) = -6.790, p = 0.000000000278, given an alpha of 0.05.
```
...
::: {.columns}
:::{.column width=80%}
![](2024_11_21_Zukunftsforum/aufbau.svg){width=90%}
...
:::
:::{.column width=20%}
{{< qrcode https://phbern-rconrardy.github.io/lerngelegenheiten/tagungsunterlagen/2025_01_27_Gebf.html >}}
